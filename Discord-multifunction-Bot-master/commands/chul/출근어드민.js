...
exports.run = async (client, message, args) => {
  ...
  if (text == '퇴근') {
    if (tr === false) return message.reply('당신은 이미 퇴근상태입니다!')
    db.set(`chuls.${message.author.id}`, false)
    db.subtract(`chulss.${message.guild.id}.admin`, 1)
